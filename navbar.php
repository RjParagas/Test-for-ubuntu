...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=upload" class="nav-item nav-upload"><span class='icon-field'><i class="fa fa-video"></i></span> Upload Videos</a>
				<a href="index.php?page=product" class="nav-item nav-product"><span class='icon-field'><i class="fa fa-dumbbell"></i></span> Add Equipment</a>
				<a href="index.php?page=categories" class="nav-item nav-categories"><span class='icon-field'><i class="fa fa-bars"></i></span> Category</a>
			<?php endif; ?>
		</div>
