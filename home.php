                ...
                <div class="card-body">
                    ...
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body bg-success">
                                    <div class="card-body text-white">
                                        ...
                                        <p><b>Active Members and Trainers</b></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body bg-success">
                                    <div class="card-body text-white">
                                        <span class="float-right summary_icon"><i class="fa fa-clipboard-list"></i></span>
                                        <h4><b>
                    ...
                    <div class="col-md-4">
                            <div class="card">
                                <div class="card-body bg-success">
                                    <div class="card-body text-white">
                                        <span class="float-right summary_icon"><i class="fa fa-dumbbell"></i></span>
                                        <h4><b>
                                            <?php echo $conn->query("SELECT * FROM product_list")->num_rows; ?>
                                        </b></h4>
                                        <p><b>Equipments</b></p>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="card">
                                <div class="card-body bg-success">
                                    <div class="card-body text-white">
                                        <span class="float-right summary_icon"><i class="fa fa-bars"></i></span>
                                        <h4><b>
