...
.upper{
    background-image: url("assets/img/gymmm.jpg");
    background-repeat:no-repeat;
    ...
    <div class="upper">
        <div class ="text">
          <h1 style="text-align: center;">
            <font style="font-size: 62px; font-weight: bold; font-family:Helvetica;">Gym Management System</font>
          </h1>
          <p class="lead o_default_snippet_text" style="text-align: center;">is designed in providing productivity in the gym and helps in keeping all the records of daily activity and transactions. This will be developed in Microsoft Visual basic 2010 and Sql Server as the database.<br/>Gym and club management systems provide fitness businesses the functionality to manage schedules, memberships, and facilities. The capabilities of gym management systems include storing member information in a database, managing financial records, scheduling classes, and reserving facilities.</p>
          <p style="text-align: center;">
            <a href="contact.php" class="btn btn-primary mb-2 o_default_snippet_text">Contact us</a>
          </p>
          </div>
        </div>
    <div>
  			...
  			<div class="card col-md-8">
  				<div class="card-body">
  					...
  					<form id="login-form" >
						  ...
						  <br>
						<center><p>Dont have an account?</p><a href="register.php">Register Now!</a></center>
  					</form>
  				</div>
  			</div>
  		</div>
