							...
							<?php
								...
								include ('db_connect.php');
									if (isset($_POST['upload'])){
										...
										$sql = "INSERT INTO videos (name,title) VALUES ('$name','$name')";
										$res =  mysqli_query($conn, $sql);

									if ($res == 1){
										echo "<br><h6> video inserted successfully </h6>";
									}
								}
								?>
					</div>
						...
						<table class="table table-bordered table-hover">
							...
							<tbody>
                                ...
                                ?>
									...
									<td class="">
                                        <video width="500" height="300" src="assets/videos/<?=$video['name']?>" 
	        	                            controls>
	                                    </video>
									</td>
                                    
									<td class="text-center">
										<button class="btn btn-md btn-outline-danger delete_video" type="button" data-id="<?php echo $row['id'] ?>">Delete</button>
									</td>
								</tr>
								<?php 
	                             }
